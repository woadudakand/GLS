...
async function init(
  ...
  map.on("dblclick", function (evt) {
    ...
    map.forEachFeatureAtPixel(evt.pixel, function (f) {
      ...
      // selectStyle.getFill().setColor(f.getProperties()?.properties?.fillColor);
      // selectStyle.getStroke().setColor('#000000')
      selectStyle.getStroke().setWidth(selectStyle.getStroke().width_ + 2);
      // selectStyle.setScale(6);
